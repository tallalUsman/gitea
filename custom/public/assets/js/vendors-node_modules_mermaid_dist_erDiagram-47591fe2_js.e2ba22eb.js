"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["vendors-node_modules_mermaid_dist_erDiagram-47591fe2_js"],{
...
/***/ "./node_modules/mermaid/dist/erDiagram-47591fe2.js":
/*!*********************************************************!*\
  !*** ./node_modules/mermaid/dist/erDiagram-47591fe2.js ***!
  \*********************************************************/
...
const addEntity = function(name, alias = void 0) {
  if (entities[name] === void 0) {
    ...
    _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Added new entity :", name);
  } else if (entities[name] && !entities[name].alias && alias) {
    entities[name].alias = alias;
    _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.l.info(`Add alias '${alias}' to entity '${name}'`);
  }
...
const addAttributes = function(entityName, attribs) {
  ...
  for (i = attribs.length - 1; i >= 0; i--) {
    ...
    _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Added attribute ", attribs[i].attributeName);
  }
};
const addRelationship = function(entA, rolA, entB, rSpec) {
  ...
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Added new relationship :", rel);
};
...
const erDb = {
  Cardinality,
  Identification,
  getConfig: () => (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.c)().er,
  addEntity,
  addAttributes,
  getEntities,
  addRelationship,
...
const drawAttributes = (groupNode, entityTextNode, attributes) => {
  ...
  attributes.forEach((item) => {
    ...
    let nodeHeight = 0;
    const attributeType = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.x)(item.attributeType);
    const typeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-type`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.c)().fontFamily).style("font-size", attrFontSize + "px").text(attributeType);
    const nameNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-name`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.c)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeName);
    const attributeNode = {};
    ...
    if (hasKeyType) {
      ...
      const keyTypeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-key`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.c)().fontFamily).style("font-size", attrFontSize + "px").text(keyTypeNodeText);
...
const draw = function(text, id, _version, diagObj) {
  conf = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.c)().er;
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Drawing ER diagram");
  ...
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.u.insertTitle(svg, "entityTitleText", conf.titleTopMargin, diagObj.db.getDiagramTitle());
  const svgBounds = svg.node().getBBox();
  const width = svgBounds.width + padding * 2;
  const height = svgBounds.height + padding * 2;
  (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.i)(svg, height, width, conf.useMaxWidth);
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_erDiagram-47591fe2_js.e2ba22eb.js.1efca50e.map